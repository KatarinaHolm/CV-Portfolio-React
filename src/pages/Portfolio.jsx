            ...
            <div className="modal-content">
              ...
              <div className="modal-text">
                ...
                <p>
                  ...
                  hur många personer varje grupp ska bestå av samt slumpmässigt
                  fördela deltagarna i olika grupper.
                </p>
              </div>
            </div>
          </div>
          ...
          <div id="popup3" className="modal">
            <div className="modal-content">
              ...
              <div className="modal-text">
                ...
                <p>
                  Projektet gav mig värdefull erfarenhet av att integrera flera
                  olika delar till ett fungerande system, samarbeta effektivt i
                  grupp och ta ansvar för en central del av applikationen.
                  Samtidigt utmanade det mig att kliva utanför min comfort zone
                  och utvecklas tekniskt.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="modal-content">
              ...
              <div className="modal-text">
                ...
                <p>
                  ...
                  tidsbokning. När jag läste Webbutveckling 1 på Komvux såg jag
                  det som ett perfekt tillfälle att skapa en hemsida till ett
                  verkligt företag.
                </p>
                <p>
                  Jag genomförde en analys av målgruppen och funderade över
                  vilken känsla hemsidan skulle förmedla. Eftersom verksamheten
                  kretsar kring racing och fart valde jag färger och typsnitt
                  som associerar till sport, bilar och energi. Designen skulle
                  ge ett modernt intryck, samtidigt som den är tydlig och lätt
                  att navigera.
                </p>
                <p>
                  En viktig del av kursen handlade om tillgänglighet, vilket jag
                  har tagit stor hänsyn till i arbetet. Texten är tillräckligt
                  stor, typsnittet är lättläst och färgkontrasterna är anpassade
                  för att göra innehållet tydligt för alla användare.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="modal-content">
              ...
              <div className="modal-text">
                ...
                <p>
                  ...
                  behövdes. Själva koden ville jag däremot skriva på egen hand.
                  För mig är det viktigt att verkligen förstå grunderna i
                  programmering och inte bara få fram ett fungerande resultat.
                </p>
                <p>
                  När jag körde fast bad jag om vägledning i stället för färdiga
                  lösningar. På så sätt fick jag hjälp att tänka vidare själv,
                  utan att tappa kontrollen över processen. Jag tror att AI lätt
                  kan bli en fälla för nybörjare, eftersom det är frestande att
                  låta den skriva koden utan att riktigt förstå hur allt hänger
                  ihop.
                </p>
                <p>
                  En detalj i spelet som jag är extra nöjd med är att figuren är
                  olika beroende på om spelaren vinner eller förlorar. Den delen
                  valde jag att skapa helt utan AI:s inblandning.
                </p>
              </div>
            </div>
          </div>
          ...
          <div id="popup6" className="modal">
            <div className="modal-content">
              ...
              <div className="modal-text">
                <h3>Databassystem för gymnasium</h3>
                <p>
                  Det sägs ofta att man i modern .NET-utveckling sällan behöver
                  skriva egen SQL, eftersom databaser numera vanligtvis skapas
                  med Code First. Samtidigt är det värdefullt att förstå hur
                  databaser är uppbyggda och hur SQL faktiskt fungerar i
                  praktiken. Det här projektet är därför skapat med Database
                  First.{" "}
                </p>
                <p>
                  Jag skapade databasen manuellt genom att skriva SQL-kod för
                  att definiera tabeller och relationer, och övade samtidigt på
                  att göra mer avancerade queries med joins. Det gav mig en
                  djupare förståelse för hur data hänger ihop bakom kulisserna.
                </p>
                <p>
                  ...
                  filtrera, söka och presentera information utifrån användarens
                  behov.
                </p>
              </div>
            </div>
